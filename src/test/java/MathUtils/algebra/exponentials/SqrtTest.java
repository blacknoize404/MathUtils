...
class SqrtTest {
    ...
    @Test
    void equalsBetweenSqrtAndRootWithArgument2() {

        MathElement variable = new Var("x");
        MathElement root = new Sqrt(variable);

        // Cuando es igual a sí mismo
        assert root.equalsTo(root);

        // Cuando son iguales
        MathElement root2 = new Root(variable, 2);
        ...
        // Cuando no lo son
        MathElement root3 = new Root(variable, 3);
